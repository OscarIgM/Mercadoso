<template>
    <div class="col-md-4 d-flex mb-4">
        <div class="card shadow" style="height: 30rem; width: 20rem;">
            <img :src="producto.image" class="card-img-top row mt-3 mx-auto w-50"
                style="width: 100%; height: 160px; object-fit: cover;" alt="...">
            <div class="card-body" style="position: relative;">
                <router-link :to="`/productlog/${producto.id}`">
                ...
                <div class="position-absolute bottom-0 end-0 btn-square" style="margin-bottom: 10px; margin-right: 10px;">
                    <button type="button" class="btn btn-primary" style="border-radius: 0; width: 8rem;">${{ producto.price
                    }}</button>
                </div>
            </div>
        </div>
